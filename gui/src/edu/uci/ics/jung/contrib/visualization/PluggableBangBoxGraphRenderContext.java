...
public class PluggableBangBoxGraphRenderContext<V, E, B>
	 ...
	 */
	protected BangBoxGraphElementAccessor<V, E, B> pickSupport;
	protected PickedState<B> pickedBangBoxState;
	protected Transformer<B, Stroke> bangBoxStrokeTransformer = new ConstantTransformer(new BasicStroke(1));
	protected Predicate<Context<BangBoxGraph<V, E, B>, B>> bangBoxIncludePredicate = TruePredicate.<Context<BangBoxGraph<V, E, B>, B>>getInstance();
	...
	public Transformer<B, Stroke> getBangBoxStrokeTransformer() {
		return bangBoxStrokeTransformer;
	}

	public void setBangBoxStrokeTransformer(Transformer<B, Stroke> bangBoxStrokeTransformer) {
		this.bangBoxStrokeTransformer = bangBoxStrokeTransformer;
	}

	public Predicate<Context<BangBoxGraph<V, E, B>, B>> getBangBoxIncludePredicate() {
		return bangBoxIncludePredicate;
	}

	public void setBangBoxIncludePredicate(Predicate<Context<BangBoxGraph<V, E, B>, B>> bangBoxIncludePredicate) {
		this.bangBoxIncludePredicate = bangBoxIncludePredicate;
	}

	public Transformer<LayoutContext<Layout<V, E>, B>, Shape> getBangBoxShapeTransformer() {
		return bangBoxShapeTransformer;
	}

	public void setBangBoxShapeTransformer(Transformer<LayoutContext<Layout<V, E>, B>, Shape> bangBoxShapeTransformer) {
		this.bangBoxShapeTransformer = bangBoxShapeTransformer;
	}

	public Transformer<B, Paint> getBangBoxFillPaintTransformer() {
		return bangBoxFillPaintTransformer;
	}

	public void setBangBoxFillPaintTransformer(Transformer<B, Paint> bangBoxFillPaintTransformer) {
		this.bangBoxFillPaintTransformer = bangBoxFillPaintTransformer;
	}

	public Transformer<B, Paint> getBangBoxDrawPaintTransformer() {
		return bangBoxDrawPaintTransformer;
	}

	public void setBangBoxDrawPaintTransformer(Transformer<B, Paint> bangBoxDrawPaintTransformer) {
		this.bangBoxDrawPaintTransformer = bangBoxDrawPaintTransformer;
	}
	...
	public void setPickSupport(GraphElementAccessor<V, E> pickSupport) {
		if (pickSupport instanceof BangBoxGraphElementAccessor) {
			this.pickSupport = (BangBoxGraphElementAccessor<V, E, B>)pickSupport;
		} else {
			throw new IllegalArgumentException("pickSupport must be BangBoxGraphElementAccessor<V, E, B>");
		}
	}
	...
	// everything below copied from PluggableGraphRenderContext
