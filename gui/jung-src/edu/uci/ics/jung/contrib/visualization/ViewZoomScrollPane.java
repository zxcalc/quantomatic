...
/**
 * ViewZoomScrollPane is a Container for the Graph's VisualizationViewer
 ...
 * or zoomed-out).
 *
 * Works just like GraphZoomScrollPane, but operates on the View layer,
 * rather than the Layout layer.
 *
...
public class ViewZoomScrollPane extends JPanel {
    ...
    /**
     * Create an instance of the ViewZoomScrollPane to contain the
     * VisualizationViewer
     * @param vv
     */
    ...
    class HorizontalAdjustmentListenerImpl implements AdjustmentListener {
        ...
        public void adjustmentValueChanged(AdjustmentEvent e) {
            ...
            if(dh != 0 && scrollBarsMayControlAdjusting) {
                ...
                float layoutScale = (float) vv.getRenderContext().getMultiLayerTransformer().getTransformer(Layer.VIEW).getScale();
                dh *= layoutScale;
                AffineTransform at = AffineTransform.getTranslateInstance(dh, 0);
                vv.getRenderContext().getMultiLayerTransformer().getTransformer(Layer.VIEW).preConcatenate(at);
            }
        }
    }
    ...
    class VerticalAdjustmentListenerImpl implements AdjustmentListener {
        ...
        public void adjustmentValueChanged(AdjustmentEvent e) {
            ...
            if(dv != 0 && scrollBarsMayControlAdjusting) {
                ...
                // get the uniform scale of all transforms
                float viewScale = (float) vv.getRenderContext().getMultiLayerTransformer().getTransformer(Layer.VIEW).getScale();
                dv *= viewScale;
