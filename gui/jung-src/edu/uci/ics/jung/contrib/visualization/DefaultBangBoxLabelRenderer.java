...
public class DefaultBangBoxLabelRenderer extends JLabel implements
        BangBoxLabelRenderer, Serializable {
     ...
     */
    public DefaultBangBoxLabelRenderer() {
        setOpaque(true);
     ...
     */
    public <B> Component getBangBoxLabelRendererComponent(JComponent vv,
                   Object value, Font font, boolean isSelected, B bangBox) {    
