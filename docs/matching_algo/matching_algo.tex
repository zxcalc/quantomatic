...
\TODOinline{everything found is a valid matching}

Given what is said in section \ref{sec:match-state} WRT global invariants, this comes down to showing that $m$ is complete at the end, which is fairly easy.
