...
\medskip
\noindent{\color{blue} Use the translation from section~\ref{sec:mbqc} to translate this program into a graph in Quantomatic, for measurement outcomes $\{ M_2^0 \rightarrow 0, M_3^0 \rightarrow 0 \}$. Implement enough rules from section~\ref{sec:zx} to normalise the measurement pattern into (\ref{eq:cnot}).}
\medskip
