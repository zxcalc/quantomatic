...
\label{fig:spider}\caption{An informal equation on graphs
...
including algebraic appoaches~\cite{corradini97algebraic}, node-label
...
interpretating graph transformations which can then be implemented to
...
replacement do not guarentee well-typed results. Furthermore, they do
not provide machinery to for rewriting of graphs with elipses
notation. 
...
In this respect, our graphs caputure the structural properties of
