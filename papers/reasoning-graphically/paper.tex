...
graphs.  In this section we will describe the generators and equations
used to reason about quantum computation, and show how some of its formal
properties lead to particular issues in for the rewriting machinery.
...
\begin{figure}
  ...
  ``colour symmetry'' so for each equation shown here gives rise to
  second obtained by exchanging the two colours.
  \begin{description}
  \item[Comonoid Laws] 
    \[
