...
\begin{center}
  \scalebox{1.0}{\includegraphics{images/spider_lhs.eps}}
\end{center}
...
nodes to the graph: {\em banged nodes} which informally represent an
arbitrary number of copies of that node, and {\em variable nodes}
which informally represent some as yet unkown node in a graph. 

\subsection{Banged Nodes}
