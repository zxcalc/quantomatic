...
sum of the $\alpha $s.  Further, one can derive from the spider
theorem $n$-fold versions of many of the other rewrites in the system.
Informally, this can be expressed as the graph equation in
Figure~\ref{informal-spider-law-fig}.
