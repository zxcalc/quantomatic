...
%%% TODO removed this because we don't need partial maps
%%% unless we are talking about plugging.
%%%
...
corresponding to either of the other two: given any one of the allows
a trivial derivation of the others.
...
%% -- we only need the unconnected !-box restriction for the merge operation. 
%  and
...
%
% TODO there ought to be formal definitions of these but not enough
