...
//  })
  ...
  val RunButton = new Button() {
    icon = new ImageIcon(QuantoDerive.getClass.getResource("start.png"), "Run buffer in Poly/ML")
    tooltip = "Run buffer in Poly/ML"
  }

  val InterruptButton = new Button() {
    icon = new ImageIcon(QuantoDerive.getClass.getResource("stop.png"), "Interrupt execution")
